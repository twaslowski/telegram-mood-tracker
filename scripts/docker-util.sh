...
function build_arm() {
  ...
  docker tag mood-tracker:armv8 "public.ecr.aws/c1o1h8f4/mood-tracker:latest-arm64v8"
  docker tag mood-tracker:armv8 "public.ecr.aws/c1o1h8f4/mood-tracker:${commit_sha}-arm64v8"
}
